<div id="sb-footer-banner" class="ctf-fb-fs ctf-bld-footer" :class="(viewsActive.pageScreen == 'welcome' && feedsList != null && feedsList.length != 0) ? 'ctf-fb-full-wrapper' : 'ctf-fb-wrapper'" v-if="(!viewsActive.footerDiabledScreens.includes(viewsActive.pageScreen) || (viewsActive.pageScreen == 'welcome' && feedsList != null && feedsList.length != 0)) && !iscustomizerScreen && activationPageDismissed">
	<div class="sb-box-shadow">
		<div class="ctf-bld-ft-content">
			<div class="ctf-bld-ft-img" v-if="!ctfRebrand" v-html="svgIcons.footer_aab_logo"></div>
			<div class="ctf-bld-ft-img" v-if="ctfRebrand" v-html="svgIcons.footer_aab_logo_x"></div>
...
<?php
	...
	include_once CTF_BUILDER_DIR . 'templates/sections/popup/license-flow-success-modal.php';
?>
