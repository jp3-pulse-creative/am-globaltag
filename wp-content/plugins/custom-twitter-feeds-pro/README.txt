...
== Changelog ==
= 2.5.0 =
* New: Added support for live Twitter broadcast videos.
* Fix: Event cards now display correctly in all layouts.
* Fix: Cards now appear in Retweets.
* Fix: Divi Builder lightbox no longer opens in new tab.
* Fix: Resolved layout and spacing issues.
