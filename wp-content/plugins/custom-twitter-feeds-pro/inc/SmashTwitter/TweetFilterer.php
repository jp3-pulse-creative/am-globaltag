...
class TweetFilterer {
	...
	public function maybe_filter_for_timeline( $tweets, $ctf_feed ) {
		...
		foreach ( $tweets as $tweet ) {
			$user = trim( strtolower( CTF_Parse_Pro::get_user_name( $tweet ) ) );
	...
	public static function maybe_filter_for_timeline_static( $tweets, $feed_options ) {
		...
		$types_and_terms = $feed_options['feed_types_and_terms'];
