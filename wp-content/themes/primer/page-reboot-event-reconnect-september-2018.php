<?php
/* Template Name: Reboot: Event - Reconnect September 2018
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 px-0">
                    <div class="videoWrp">
                        <iframe id="youtube1" src="https://www.youtube.com/embed/Oeo4Akk67SA?rel=0" frameborder="0"
    ...
    <div id="section-reconnect5">
        ...
        <center>
            <a href="https://pulsecreative.zenfolio.com/p1031944827" target="_blank"><img class="" src="https://am-globaltag.com/wp-content/themes/bones/images/amb2b9-2018-4.png"></a>
