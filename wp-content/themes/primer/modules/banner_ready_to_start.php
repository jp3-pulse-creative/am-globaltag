...
$contact_link_target = !empty($contact_link['target']) ? $contact_link['target'] : '_self';
...
$linkedin_link_url = $linkedin_link['url'] ?? '';
?>
<style>
    .contact-info {
        max-width: 233px;
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-8 order-1 order-lg-0">
                ...
                <?php } ?>
                <?php if ($contact_link_url) { ?>

                    <a href="<?php echo esc_url($contact_link_url) ?>" target="<?php echo esc_attr($contact_link_target) ?>" class="cta-btn mt-2">
            ...
            <div class="col-12 col-lg-4 order-0 order-lg-1">
                <div class="contact-info">
                    ...
                    <div class="contact-info d-flex mx-auto">
                        <?php if ($linkedin_link_url) { ?>
                        <div class="contact-info__linked-in mr-3">
                            <a href="<?php echo esc_url($linkedin_link_url); ?>" target="_blank">
