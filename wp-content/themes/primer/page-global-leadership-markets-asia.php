<?php
/* Template Name: Reboot: GL-Markets - Asia
 */
get_header(); ?>
        ...
        ?>
            ...
            <div id="glmt-<?php echo $marker ?>" class="glm-team-slide global-leaders">
              <div class="glm-team-head col-12 px-0 px-0">
                ...
                <?php if (is_page('Global Leadership Asia') &&  $team_counter == 0): ?>
                  <h2 class="section-title"><?php echo 'Asia Leadership'; ?></h2>
...
<div id="our-services" class="pepi-row gl__ourservices">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-12 px-0 col-md-6 order-1 order-md-2 px-md-0 mb-4 mb-md-0">
      ...
      <div class="col-12 px-0 col-md-6 order-2 px-md-0">
        <div class="ml-md-5 pl-md-4">
          ...
          <ul class="m-0 pl-3 spaced-list">
            ...
            <li>Integrated Approach That Combines Transaction Advisory, Tax <br class="d-none d-md-inline">and
              Operational Performance Improvement Expertise</li>
  ...
  <div class="container">
    ...
    <div class="row row__locations">
      <div class="col-12 px-0 pr-md-0">
        <h3 class="gl-location gl-location__country">CHINA</h3>
      </div>

      <div class="col-md-5 px-0">
        <address>
          <h4 class="gl-location gl-location__city">Beijing</h4>
          Unit 2401-11, 24/F<br>
          China World Office 2<br>
          1 Jianguomenwai Avenue<br>
          Chaoyang District Beijing 100004<br>
          <a class="gl-location gl-location__link" href="https://goo.gl/maps/TJPQf7gX8wPCpENT6" target="_blank"><i
      ...
      <div class="col-md-7 px-0 px-md-0">
        <div class="row no-gutters">
          <div class="col-md-7 px-0">
            <address>
              <h4 class="gl-location gl-location__city">Hong Kong</h4>

              Rooms 405-7, 4/F<br>
              St George’s Building<br>
              2 Ice House Street<br>
              Central Hong Kong<br>
              <a class="gl-location gl-location__link" href="https://goo.gl/maps/gXd9hYm5t9aY2V1Z8">
          ...
          <div class="col-md-5 px-0">
            <address>
              <h4 class="gl-location gl-location__city">Shanghai</h4>

              Unit 1704, Level 17
              Five Corporate Ave<br>
              150 Hubin Road<br>
              Huangpu District Shanghai 200021<br>
              <a class="gl-location gl-location__link"
                href="https://www.google.com/maps/search/Level+17+Five+Corporate+Ave+150+Hubin+Road+Huangpu+District+Shanghai+200021/@31.2201533,121.4687752,15z/data=!3m1!4b1">
                <i class="icon-map-marker">
                  <img src="<?php echo get_template_directory_uri(); ?>/library/images/reboot/icons/icon-map-marker.svg"
                    alt=""></i> <span>View in Map</span></a>
            </address>
      ...
      <div class="col-md-5 px-0">
        <address>
          <h4 class="gl-location gl-location__city">Singapore</h4>
          Unit 74, 39/F Marina Bay<br>
          Financial Centre, Tower 2<br>
          10 Marina Boulevard<br>
          Singapore 018983<br>
          <a class="gl-location gl-location__link"
            href="https://www.google.com/search?q=alvarez+and+marsal+singapore&tbm=lcl&ei=m_UKY5-oHrrckPIPlcKOsAw&oq=alvarez+and+marsal+singapore&gs_l=psy-ab.3..0i512k1l2.4254.5808.0.5954.9.5.0.4.4.0.134.366.0j3.3.0....0...1c.1.64.psy-ab..2.7.371...0i30i22k1.0.g6ua1Ik7Mkk#rlfi=hd:;si:11014312253995543080,l,ChxhbHZhcmV6IGFuZCBtYXJzYWwgc2luZ2Fwb3JlIgOIAQFaKCIcYWx2YXJleiBhbmQgbWFyc2FsIHNpbmdhcG9yZSoICAIQABABEAKSAR5idXNpbmVzc19tYW5hZ2VtZW50X2NvbnN1bHRhbnQ;mv:[[1.2857171773190301,103.85198712262996],[1.2853572226809706,103.85162707737005]]"
