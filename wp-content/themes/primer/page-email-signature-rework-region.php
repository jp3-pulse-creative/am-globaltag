<?php /* Template Name: Email Signature Sandbox 2 */ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;padding: 0; border: none; width: 60%;" align="left">
                                            <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 100%; padding: 0 0 0 20px; font-family: Arial, sans-serif; font-size: 9pt; font-weight: 700; line-height: 12px; color: #00244A; border: none !important; border-collapse: collapse; border-spacing: 0;" align="left">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse; border-spacing: 0;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="width: 100%; padding: 0; font-family: Arial, sans-serif; font-size: 9pt; font-weight: 700; line-height: 12px; color: #00244A; border: none !important; border-collapse: collapse; border-spacing: 0;" align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 100%; padding: 5px 0 5px; font-family:  Arial, sans-serif; font-size: 9pt; line-height: 12px; font-weight: 700; color:#00244A; border: none !important; border-collapse: collapse; border-spacing: 0;" align="left">
...
<script>
    ...
    function updateSignature() {
        ...
        const addressOneElement = document.getElementById('signature-address-line-one');
        const addressTwoElement = document.getElementById('signature-address-line-two');
        const addressThreeElement = document.getElementById('signature-address-line-three');

        if (signatureEmailElement) signatureEmailElement.textContent = email;
        if (emailLinkElement) emailLinkElement.href = `mailto:${email}`;
        if (addressOneElement) addressOneElement.textContent = addressLineOne;
        if (addressTwoElement) addressTwoElement.textContent = addressLineTwo;
        if (addressThreeElement) addressThreeElement.textContent = addressLineThree;
        ...
        console.log('Phone One:', phoneOne, 'Region:', phoneOneRegion);
        if (phoneOne && phoneOne.trim() !== '') {
            ...
            if (!phoneOneRow) {
                ...
                if (titleRow && titleRow.nextSibling && tableBody.contains(titleRow.nextSibling)) {
                ...
                // Update existing row
                const phoneElement = document.getElementById('signature-phone-one');
                const phoneLinkElement = document.getElementById('signature-phone-one-link');
                const labelElement = phoneOneRow.querySelector('span');

                if (phoneElement) phoneElement.textContent = phoneOne;
                if (phoneLinkElement) phoneLinkElement.href = `tel:${phoneOne}`;
