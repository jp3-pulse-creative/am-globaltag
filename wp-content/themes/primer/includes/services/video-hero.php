...
<?php if(get_field('hero_video')){ echo 'video-bg'; }?>
			...
			?>
				...
				<div class="vid-hero-ctn vh-corner">
					...
					<h4 class="name"><?php echo get_field('first_name', $team_member); ?> <?php echo get_field('last_name', $team_member); ?></h4>
					<h4 class="title"><?php echo get_field('job_title', $team_member)['label'] ?></h4>
				</div>
				<?php
