...
<![endif]-->
    ...
    <script type='text/javascript' src='<?php echo get_template_directory_uri(); ?>/library/js/isotope.pkgd.min.js'>
    </script>
...
<body>
    <header id="sticky-header" class="header<?php if (is_front_page()) {
                                                ...
                                                echo ' home';
                                            } ?>" <?php if (is_singular('crg-story') || is_singular('team')) {
                    ...
                    <div class="grid grid-header">
                        ...
                        <div class="header-item logo">
                            <a href="<?php echo site_url() ?>">
                                ...
                                <img src="<?php echo get_template_directory_uri(); ?>/library/images/reboot/am-tag-logo-white.svg" width="220" height="68" alt="Alvarez and Marsal - Global TAG" />
    ...
    <header id="sticky-header-2" class="d-none d-lg-block header header-2<?php if (is_front_page()) {
                                                                                // This is the blog posts index
                                                                                echo ' home';
                                                                            } ?>">
        <div class="container">
