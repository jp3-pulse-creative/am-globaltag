<?php
/* Template Name: Reboot: Event - B2B May 2018
...
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row pb-5 mb-4">
                ...
                <div class="col-md-8">
                    ...
                    <p style="font-size: 18px; line-height: 22px;">Thank you all for coming to A&M Asia’s Back to
                        Business networking event.<br class="d-none d-md-inline">Here’s a few moments from the
                        evening. Enjoy!
                    </p>
                </div>
    ...
    <div id="section-reconnect2">
        ...
        <center>
            <a href="http://pulsecreative.zenfolio.com/p547597114" target="_blank"><img class=""
                    src="https://am-globaltag.com/wp-content/themes/bones/images/back-may-2018-th1.png"></a>
            <a href="http://pulsecreative.zenfolio.com/p545886669" target="_blank"><img class=""
                    src="https://am-globaltag.com/wp-content/themes/bones/images/back-may-2018-th2.png"></a>
