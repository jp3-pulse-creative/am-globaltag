	...
	<div class="container">
		<div class="row">
			...
			if ($recruitment_campaigns->have_posts()) :
				...
				<div class="col-md-6 pl-md-0 mt-4">
					<div class="recruitment-campaign-item" style="background-color: #fff; height: 100%; display: flex; flex-direction: column;">
						...
						<div class="campaign-content p-5" style="height: 100%; display: flex; flex-direction: row; flex-wrap: wrap;">
							...
							<?php if ($excerpt) : ?>
								<p class="mt-3 mb-4 w-100"><?php echo $excerpt; ?></p>
							<?php endif; ?>

							<!-- click here -->
							<a href="#" class="cta-btn watch-video-trigger mt-4 w-100" data-video-id="<?php echo get_the_ID(); ?>" style="align-self: flex-end; margin-top: auto;">
