<?php
/* Template Name: Reboot: Event - B2B January 2017
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
    ...
    <div id="section-reconnect">
        ...
        <center>
            ...
            <a href="http://pulsecreative.zenfolio.com/p975708986" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/reconnect-image-links_01.png"></a>
            <a href="http://pulsecreative.zenfolio.com/p827486336" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/reconnect-image-links_02.png"></a>
            <a href="http://pulsecreative.zenfolio.com/p752994428" target="_blank"> <img class="" src="<?php echo get_template_directory_uri(); ?>/images/reconnect-image-links_03.png"></a>
