...
<div id="section-filter" >
  <div class="container">
    <div class="row">
      <div class="filter-table news-table desktop-table">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              <td width="123px" align="center" valign="middle">FILTER RESULTS:</td>
              ...
              <td width="105px" align="left" valign="top"><a id="sel-filter" href="<?php echo get_site_url() ?>/search-deal-highlights?yr=<?php echo $currY ?>"><img src="<?php bloginfo('template_url'); ?>/images/btn-apply.png"/></a></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <div class="panel panel-default">
          ...
          <div id="content1" class="panel-collapse collapse collapsed">
            <div class="panel-body">
              <div class="filter-table news-table">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td width="123px" align="center" valign="middle">FILTER RESULTS:</td>
...
<div class="col-md-12 section-white not-white">
  <div id="section-4" class="row">
    ...
    <h5>
      ...
      if ( $serv_name != '' ) {
        echo '<span class="ry">Service:</span> ' . $serv_name . ' <span class="sd">/</span> ';
      }

      $industry_name = get_category_by_slug( $p_industry );
      $industry_name = $industry_name->name;
      if ( $industry_name != '' ) {
        echo '<span class="ry">Industry:</span> ' . $industry_name . ' <span class="sd">/</span> ';
      }

      $country_name = get_category_by_slug( $p_country );
      $country_name = $country_name->name;
      if ( $country_name != '' ) {
        echo '<span class="ry">Country:</span> ' . $country_name . ' <span class="sd">/</span> ';
      }
...
-->
    ...
    <div class="col-sm-6 col-md-4">
      <div class="news-block-2 ms"> <a href="<?php the_field('source'); ?>" target="_blank">
        <div class="news-block-feature">
          <h1>
            <?php the_field('client'); ?>
          </h1>
          <img src="<?php the_field('home-thumb'); ?>"/></div>
        </a>
        ...
        <h3>Congratulations to our client,<br>
          <?php the_field('client'); ?>! </h3>
        <h4> Global Transaction Advisory Group</h4>
        <p> <strong> Services Provided:<br>
          <?php the_field('services'); ?>
          </strong> <br>
          <a class="excerpt" href="<?php the_field('source'); ?>" target="_blank"> Read More &#8250;&#8250; </a></p>
      </div>
    </div>
