<?php
/*
 Template Name: Events Reconnect January 2019
 *
...
<div class="col-md-1"></div>
  <div class="col-md-10">
  <div class="tho-in">
	  <center>  <img class="single-header-image-252019" src="<?php bloginfo('template_url'); ?>/images/2-4-2019-sm.png" />  </center>
   <h2></h2>
...
<!--/video========-->
  ...
  <div id="section-reconnect6">
	  <center>
		  <a href="https://pulsecreative.zenfolio.com/p324066185/hC320FB95#hc320fb95" target="_blank"><img class="" src="<?php bloginfo('template_url'); ?>/images/2-4-2019-photos.jpg"/></a>
