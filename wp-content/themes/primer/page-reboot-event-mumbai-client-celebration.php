<?php
/* Template Name: Reboot: Event - Mumbai Client Celebration
...
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row pb-5 mb-4">
                ...
                <div class="col-md-8">
                    ...
                    <p style="font-size: 18px; line-height: 22px;">On February 20th, Alvarez & Marsal hosted a special
                        event to celebrate 10 years of success in India together with clients, partners and special
                        host, A&M Co-Founder & Co-CEO, Bryan Marsal. Thank you all for coming to this milestone
                        celebration for our India team.<br class="d-none d-md-inline">Here’s a few moments from the
                        evening. Enjoy!
                    </p>
                </div>
    ...
    <div id="section-reconnect7">
        ...
        <center>
            <a href="https://pulsecreative.zenfolio.com/p999879548" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/mumbai-photo.jpg"></a>
