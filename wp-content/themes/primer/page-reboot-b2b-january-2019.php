<?php
/* Template Name: Reboot: Event - B2B January 2019 - Reconnect
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 px-0">
                    <div class="videoWrp">
                        <iframe id="youtube1" src="https://www.youtube.com/embed/7hX1efg24sg?rel=0" frameborder="0"
    ...
    <div id="section-reconnect6">
        ...
        <center>
            <a href="https://pulsecreative.zenfolio.com/p324066185/hC320FB95#hc320fb95" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/2-4-2019-photos.jpg"></a>
