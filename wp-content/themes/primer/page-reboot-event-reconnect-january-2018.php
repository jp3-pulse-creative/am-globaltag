<?php
/* Template Name: Reboot: Event - Reconnect January 2018
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 px-0">
                    <div class="videoWrp">
                        <iframe id="youtube1" src="https://www.youtube.com/embed/UqiabhuQapc?rel=0" frameborder="0"
    ...
    <div id="section-reconnect2">
        ...
        <center>
            <a href="http://pulsecreative.zenfolio.com/p719731699" target="_blank"><img class="" src="https://am-globaltag.com/wp-content/themes/bones/images/amb2b2018-pg-1.jpg"></a>
