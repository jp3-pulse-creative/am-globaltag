        ...
        <div class="container">
            ...
            <?php } else { */ ?>
                ...
                <div class="col-12 col-md-6 pl-md-5 mt-5 mb-0 align-self-end table">
                    <div>
                        <span>
                            <table id="signature" border="0" cellspacing="0" cellpadding="0" style="font-family: Arial, sans-serif; color: #000000; font-size: 9pt; line-height: 12px; border-collapse: collapse; border-spacing: 0; width: 100%; max-width: 500px;">
                                <tbody>
                                    <tr>
                                        <td style="padding: 0; vertical-align: middle; border-collapse: collapse; border-spacing: 0; border-top: none; border-right: 2px solid #0084C7; border-bottom: none; border-left: none; width: 50%;">
                                        ...
                                        <td style="padding: 0; border: none; width: 50%;" align="left">
                                            <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-spacing: 0;">
                                                <tbody>
                                                    <tr>
