...
<body>
    <header id="" class="d-none d-lg-block header header-2 header-nostick">
        <div class="container">
            <div class="row">
            ...
            <div class="primary-menu-body">
                <div class="primary-menu-head">
                    ...
                    <div class="logo">
                        <a href="<?php echo site_url(); ?>">
                            ...
                            <img class="" src="<?php echo get_template_directory_uri(); ?>/library/images/reboot/am-tag-logo-white.svg" width="152" height="43" alt="Alvarez and Marsal - Global TAG">
                ...
                <div class="primary-menu-list-ctn">
                    <div class="primary-menu-list">
                        <?php wp_nav_menu(array(
                            'container' => false,                           // remove nav container
                            'menu' => __('Other Sites Submenu', 'primer'),  // nav name
