<?php
/* Template Name: Reboot: CPTS + Query: GL-Markets Europe & Middle East
 */
get_header(); ?>
        ...
        <div class="glm-info-slider">
          ...
          if ($market_query->have_posts()) :
            while ($market_query->have_posts()) :
              ...
              $bg_image = get_field('slide_image');
              // allows for first slide to have custom title vs. the Country/Market
              $title_market = get_field('title_market');
              // allows for custom order and punctuation + nobody is assinged Düsseldorf
              $glm_cities = get_field('glm_cities');
              $main_text_box = get_field('main_text_box');
              $side_text_box_true = get_field('side_text_box_true');
              $side_text_box_repeater = get_field('side_text_box_repeater');



          ?>

              <div id="glms-<?php echo $reg_counter ?>" class="glm-info-slide">
                <style>
                  #glms-<?php echo $reg_counter; ?> {
                    background-color: #002B49;

                  }

                  #glms-<?php echo $reg_counter; ?>::before {
                    content: '';
                    position: absolute;
                    left: 0;
                    top: 0;
                ...
                <div class="d-flex flex-wrap">
                  <div class="col-12 px-0">
                    <?php if ($title_market) {
                      echo '<h2 class="glm-heading glm-heading__country">' . $title_market . '</h2>';
                    } ?>

                    <?php if ($glm_cities) {
                      echo '<h3 class="glm-heading glm-heading__city">' . $glm_cities . '</h3>';
                    } ?>

                  </div>

                  <div class="col-md-<?php if ($side_text_box_true) {
                                        echo '9';
                                      } else {
                                        echo '10';
                                      } ?> px-0">

                    <?php echo '<div class="main-text">' . $main_text_box . '</div>'; ?>



                  </div>
                  <?php if ($side_text_box_true) : ?>
                    <div class="col-md-3">
                      <?php $sidebox = $side_text_box_repeater;
    ...
    <div class="row d-block">
      <div class="glm-team-slider">
        ...
        ?>
            ...
            <div id="glmt-<?php echo $team_counter ?>" class="glm-team-slide global-leaders">
              <div class="glm-team-head col-12 px-0 px-0">

                <h2 class="section-title">Europe -
                  <?php
                  // allows for custom order and punctuation + nobody is assinged Düsseldorf
                  echo $glm_cities;
                  ?>
              ...
              <div class="glm-team-list">
                ...
                <?php
                $country = get_field('team_members_taxonomy');
                ...
                $country_query = get_posts($args2);
                foreach ($country_query as $post) : setup_postdata($post);
            ...
            ?>
              ...
              <?php if ($team_counter == 0): ?>
                ...
                <div class="glm-team-head middle-east col-12 px-0 px-0">

                  <h2 class="section-title">Middle East Leadership (EMEA)</h2>
                  <div class="short-border"></div>
                </div>
