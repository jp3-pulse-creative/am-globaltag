<?php
/* Template Name: Reboot: Event - Reconnect Engage January 2019
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
    ...
    <div id="section-reconnect7">
        <center>
            <a href="https://pulsecreative.zenfolio.com/p586136441/hD68101DD#hd68101dd" target="_blank"><img class=""
                    src="<?php echo get_template_directory_uri(); ?>/images/nd-photo.jpg"></a>
