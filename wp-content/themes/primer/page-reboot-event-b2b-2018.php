<?php
/* Template Name: Reboot: Event - B2B  January 2018 - Reconnect
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
    ...
    <div id="section-reconnect2">
        ...
        <center>
            <a href="http://pulsecreative.zenfolio.com/p719731699" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/amb2b2018-pg-1.jpg"></a>
