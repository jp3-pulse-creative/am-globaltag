<?php
/* Template Name: Reboot: Event -  B2B September 2018 - Reconnect
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
    ...
    <div id="section-reconnect5">
        ...
        <center>
            <a href="https://pulsecreative.zenfolio.com/p1031944827" target="_blank"><img class="" src="<?php echo get_template_directory_uri(); ?>/images/amb2b9-2018-4.png"></a>
