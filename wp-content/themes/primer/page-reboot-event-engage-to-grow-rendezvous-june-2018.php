<?php
/* Template Name: Reboot: Event - Engage to Grow Rendezvous June 2018
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
    ...
    <div id="section-reconnect4">
        <center>
            <a href="http://pulsecreative.zenfolio.com/p707145989" target="_blank"><img class=""
                    src="<?php echo get_template_directory_uri(); ?>/images/engage-3.jpg"></a>
