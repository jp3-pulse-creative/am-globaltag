<?php
/* Template Name: Reboot: Event - B2B September 2017 - Reconnect
*/
get_header(); ?>
<div id="b2b-2019" class="wrapper b2b-2019 event-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 px-0">
                    <div class="videoWrp">
                        <iframe id="youtube1" src="https://www.youtube.com/embed/3SZaV8zvskk?rel=0&amp;enablejsapi=1"
    ...
    <div id="section-reconnect">
        ...
        <center>
            ...
            <a href="https://pulsecreative.zenfolio.com/p634582177" target="_blank"><img class=""
                    src="<?php echo site_url(); ?>/wp-content/uploads/2018/09/1a.png"></a>
            <a href="https://pulsecreative.zenfolio.com/p992967480" target="_blank"><img class=""
                    src="<?php echo site_url(); ?>/wp-content/uploads/2018/09/2a.png"></a>
            <a href="https://pulsecreative.zenfolio.com/p1002245317" target="_blank"> <img class=""
                    src="<?php echo site_url(); ?>/wp-content/uploads/2018/09/3a.png"></a>
