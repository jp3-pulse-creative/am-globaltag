<?php
/*
 Template Name: B2B September 2019
 *
...
<div class="col-md-1"></div>
  <div class="col-md-10">
  <div class="tho-in">
	  <center>  <img class="single-header-image-252019" src="<?php bloginfo('template_url'); ?>/images/b2b-sept-header.png" />  </center>
   <h2></h2>
...
<!--/video========-->
  ...
  <div id="section-reconnect9">
	  <center>
		  <a href="https://pulsecreative.zenfolio.com/p805380758/hD7605431#hd7605431" target="_blank"><img class="" src="<?php bloginfo('template_url'); ?>/images/b2b-sept-photos.jpg"/></a>
