<?php
/* Template Name: Reboot: GL-Markets - Latin America
 */
get_header(); ?>
                    ...
                    ?>
                            ...
                            <div id="glms-<?php echo $marker ?>" class="glm-info-slide">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <?php else: ?>
                                        <div class="col-12 px-0">
                                            <h2 class="glm-heading glm-heading__country"><?php echo 'Latin America'; ?></h2>
                                    ...
                                    <div class="col-md-<?php if ($info['side_text_box_true']) {
                                        ...
                                        <div class="main-text">
                                            ...
                                            <p>
                                                A&M Latin America Transaction Advisory Group offers seamless transaction
                                                advisory to both local and inbound cross-border clients through both the
                                                Hispanic and Lusophone countries of the region. We offer the full spectrum of
                                                transaction services aimed at providing hands-on and flawless quality support
                                                throughout the M&A process, in what can be a challenging regional deal
                                                environment.
                                            </p>
                                            <p>
                                                We have senior-led teams that are fluent in English in São Paulo and Mexico City
                                                that have extensive experience in multiple sectors and throughout the region and
                                                the globe. Our team services private equity, sovereign wealth funds, and
                                                multi-national corporations to create value throughout the investment lifecycle.
                                            </p>
                                        </div>
                        ...
                        <div id="glmt-<?php echo $marker ?>" class="glm-team-slide global-leaders">
                            <div class="glm-team-head col-12 px-0">
                                ...
                                <?php if ($team_counter == 0): ?>
                                    <h2 class="section-title"><?php echo 'Latin America Leadership'; ?></h2>


                                <?php else: ?>
                                    <h2 class="section-title"><?php echo 'Latin America - ' . $teams['info_designation']; ?></h2>
                                <?php endif; ?>
                                                ...
                                                <div class="insight-block bg-lighter-grey">
                                                    ...
                                                    <div class="pt-3 px-3 pb-4 d-flex flex-column h-100">
                                                        ...
                                                        <a class="plain-btn mt-auto"
                                                            href="<?php echo  get_field('external_link', $tm->ID); ?>"
            ...
            <div class="row align-items-center">
                <div class="col-12 px-0 col-md-6 order-2 order-md-1 px-md-0">
                    ...
                    <ul class="m-0 pl-3 spaced-list">
                        ...
                        <li>Valuation Services (Including Business Modelling and<br class="d-none d-md-inline">Purchase
                            Price Allocation)</li>
                ...
                <div class="col-12 px-0 col-md-6 order-1 order-md-2 px-md-0">
                    ...
                    <img class="img-fluid" src="<?php echo site_url(); ?>/wp-content/uploads/2022/08/services-image.jpg"
                        alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 px-0 col-md-6 order-2 px-md-0">
                    <div class="ml-md-5 pl-md-4">
                        ...
                        <div class="short-border"></div>
                        <ul class="m-0 pl-3 spaced-list">
                            <li>Seamless Integrated Approach to Due Diligence and<br />Transaction Advisory Across All
                                Work-streams</li>
        ...
        <div class="container">
            ...
            <div class="row row__locations">
                <div class="col-md-5 px-0">
                    <h3 class="gl-location gl-location__country">Brazil</h3>


                    <address>
                        <h4 class="gl-location gl-location__city">São Paulo</h4>
                        Ed. Igarassu Rua Surubim,<br>
                        577 20° andar São Paulo-SP-Brazil,<br>
                        São Paulo, 04571-050<br>
                        <a class="gl-location gl-location__link" href="https://goo.gl/maps/8KCDuoPpbskiEmfv9"
                ...
                <div class="col-md-7 px-0 px-md-0">
                    <div class="row no-gutters">
                        <div class="col-md-7 px-0">
                            <h3 class="gl-location gl-location__country">Mexico</h3>

                            <address>
                                <h4 class="gl-location gl-location__city">Mexico City</h4>

                                Montes Urales 505 PB<br>
                                Lomas de Chapultepec<br>
                                Mexico City, 110001<br>
                                <a class="gl-location gl-location__link" href="https://goo.gl/maps/WeqVV1Xgcxc3PvAg6">
