<?php
/*
 Template Name: Events Stockholm Office Opening 2017
 *
...
#section-reconnect {
	background: url("<?php echo site_url();?>/wp-content/themes/bones/images/soo-2.jpg") center top no-repeat;
...
<div class="col-md-1"></div>
  <div class="col-md-10">
  <div class="tho-in">
	  <center>  <img class="single-header-image-2" src="<?php echo site_url();?>/wp-content/themes/bones/images/soo-1.png" />  </center>
   <h2></h2>
...
<p style="font-size: 18px; line-height: 22px;">Thank you all for coming to our Alvarez & Marsal Stockholm office opening.
Here’s a few photos from the evening. Enjoy!</p>
  ...
  <div id="section-reconnect">
	  <center>
		  ...
		  <a href="https://pulsecreative.zenfolio.com/p600281717" target="_blank"><img class="pl-1" src="<?php echo site_url();?>/wp-content/themes/bones/images/soo-th1.png"></a>
 <a href="https://pulsecreative.zenfolio.com/p893074625" target="_blank"><img class="pl-2" src="<?php echo site_url();?>/wp-content/themes/bones/images/soo-th2.png"/></a>
