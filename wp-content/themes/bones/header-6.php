...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/css/slick.css" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/css/glv3.css" />
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/scss/gl-template/gl-template.css" />
    ...
    <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/library/js/slick.min.js"></script>
    ...
    <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/library/js/glv3.js"></script>
...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/WebPage">
    ...
    <?php get_template_part('/includes/navbar/navbar-pepi.php'); ?>
    <?php // get_template_part('/includes/navbar/navbar-6.php'); 
    ?>