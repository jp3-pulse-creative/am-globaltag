<?php
/*
 Template Name: Events Reconnect 2018
 *
...
<section id="promo-rsvp" class="content-block promo-rsvp tho-top"> 
  ...
  <div class="col-md-10">
  <div class="tho-in">
	  <center>  <img class="single-header-image-2" src="<?php bloginfo('template_url'); ?>/images/amb2b2018-1.png" />  </center>
   <h2></h2>
...
Here's a few moments from the evening. Enjoy!</p>
  ...
  <div class="container">
<iframe id="youtube1" src="https://www.youtube.com/embed/UqiabhuQapc?rel=0" frameborder="0" allowfullscreen></iframe>
	  </div>
  </div>
<!--/video========-->
  ...
  <div id="section-reconnect2">
	  <center>
		  <a href="http://pulsecreative.zenfolio.com/p719731699" target="_blank"><img class="" src="<?php bloginfo('template_url'); ?>/images/amb2b2018-pg-1.jpg"/></a>
