...
<!--  <div class="overlay"></div>-->
  ...
  <!---->
     ...
     <div class="item slides active">
      <div class="slide-tl-1"></div>
       <a href="<?php echo get_site_url(); ?>/thought_leadership/cross-border-ma-2018-trends-factors-impacting-europe/"> 
      <div class="hero-2">
       <h2>Cross-Border M&A 2018 Trends: Factors Impacting Europe</h2>
		  <p>December 13, 2018  |  Europe</p>
	</div>
	   </a>
  ...
  <div class="item slides">
      <div class="slide-tl-2"></div>
       <a href="<?php echo get_site_url(); ?>/thought_leadership/cross-border-ma-2018-trends-factors-impacting-the-united-states/"> 
      <div class="hero-2">
       <h2>Cross-Border M&A 2018 Trends: Factors Impacting the United States</h2>
		  <p>September 27, 2018  |  North America</p>
	</div>
	   </a>
...
<!---->
  <div class="item slides">
      <div class="slide-tl-3"></div>
       <a href="<?php echo get_site_url(); ?>/thought_leadership/cross-border-ma-2018-trends-factors-impacting-india/"> 
      <div class="hero-2">
       <h2>Cross-Border M&A 2018 Trends: Factors Impacting India</h2>
		  <p>September 4, 2018  |  India</p>
	</div>
	   </a>
