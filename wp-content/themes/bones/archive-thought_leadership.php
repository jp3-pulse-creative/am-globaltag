...
<!--  <div class="overlay"></div>-->
  ...
  <div class="carousel-inner">
            ...
            <div class="slide-tl-1" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/11-4-2020.jpg)"></div>
            <a href="<?php echo get_site_url(); ?>/thought_leadership/diligence-insights-treatment-of-ppp-loans-in-a-transaction/"> 
                <div class="hero-2">
                    <h2>Diligence Insights: Treatment of PPP Loans in a Transaction</h2>
                    <p>November 4, 2020 |  North America</p>
                </div>
            </a>
        </div>
    
                            <div class="item slides">
            <div class="slide-tl-1" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/uploads/2020/10/10-14-2020_02.jpg)"></div>
            <a href="<?php echo get_site_url(); ?>/thought_leadership/infrastructure-pulse-americas-q3-2020/"> 
                <div class="hero-2">
                    <h2>Infrastructure Pulse Americas Q3 2020</h2>
                    <p>October 14, 2020 |  Americas</p>
                </div>
            </a>
        </div>
     
                <div class="item slides">
            <div class="slide-tl-1" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/uploads/2020/10/10-14-2020_01.jpg)"></div>
            <a href="<?php echo get_site_url(); ?>/thought_leadership/infrastructure-pulse-europe-q3-2020/"> 
                <div class="hero-2">
                    <h2>Infrastructure Pulse Europe Q3 2020</h2>
                    <p>October 14, 2020 |  Europe</p>
                </div>
            </a>
        </div>
