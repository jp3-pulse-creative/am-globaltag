<?php
/*
 Template Name: Thought Leadership Author Links
 *
...
<!--	  <center>   <img class="single-header-image" src="<?php the_field ('header-image'); ?>"/></center>-->
	  <div class="t-email"><strong>Alvarez & Marsal Transaction Advisory Group</strong></div>
  ...
  <div class="col-md-6">
	 <a href="><?php echo get_field( "author_link_1" ) ?>" target="_blank"> <strong><?php echo get_field( "author_name_1" ) ?></strong></a><br/>
  ...
  <div class="col-md-6">
	  <a href="><?php echo get_field( "author_link_2" ) ?>" target="_blank"><strong><?php echo get_field( "author_name_2" ) ?></strong></a><br/>
...
<section class="content-block-1 tho-lead">
 ...
 <div class="col-md-1">
  <div class="soc-share">
	...
	<li><a href="https://twitter.com/home?status=https%3A//www.am-globaltag.com/<?php echo $post->post_name; ?>" target="_blank"><span class="fa fa-twitter"> </span></a></li>
	<li><a href="https://plus.google.com/share?url=https%3A//www.am-globaltag.com/<?php echo $post->post_name; ?>" target="_blank"><span class="fa gp fa-google-plus"> </span></a></li>
	<li><a href="mailto:?&subject=Alvarez & Marsal Transaction Advisory: <?php the_title() ?>&body=Hi,%0A%0AI%20thought%20you%20might%20be%20interested%20in%20this%20article%3A%0A%0Ahttps%3A//www.am-globaltag.com/10thanniversary/<?php echo $post->post_name; ?>" target="_blank"><span class="fa fa-envelope"> </span></a></li>
	</ul>
	<div class="t-divide"></div>
  </div>
  </div>
