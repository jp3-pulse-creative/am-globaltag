<?php
/*
 Template Name: Thought Leadership EOY Paul
 *
...
.eoy-title1 {
background: url("<?php echo get_site_url(); ?>/wp-content/uploads/2018/01/man-title1-2.jpg") center top no-repeat;
}	
.eoy-title2 {
background: url("<?php echo get_site_url(); ?>/wp-content/uploads/2018/01/man-title2-2.jpg") center top no-repeat;
}	
...
<section class="content-block-1 tho-lead">
 ...
 <div class="col-md-1">
  <div class="soc-share">
	...
	<li><a href="https://plus.google.com/share?url=https%3A//www.am-globaltag.com/<?php echo $post->post_name; ?>" target="_blank"><span class="fab gp fa-google-plus"> </span></a></li>
	<li><a href="mailto:?&subject=Alvarez & Marsal Transaction Advisory: <?php the_title() ?>&body=Hi,%0A%0AI%20thought%20you%20might%20be%20interested%20in%20this%20article%3A%0A%0Ahttp%3A//www.am-globaltag.com/<?php echo $post->post_name; ?>" target="_blank"><span class="fa fa-envelope"> </span></a></li>
	</ul>
	<div class="t-divide"></div>
  </div>
  </div>
