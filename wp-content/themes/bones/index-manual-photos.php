...
<div class="spacer"></div>
    ...
    <div class="row">
        <div class="isotope-gallery-container">
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper events photobooth">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                         <img src="<?php bloginfo('template_url'); ?>/images/pic1.jpg" border="0" alt="" title="" class="img-responsive"/>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper nature outside">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <img src="<?php bloginfo('template_url'); ?>/images/pic2.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
            ...
            <!-- /.gallery-item-wrapper -->
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper photography events">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                           <img src="<?php bloginfo('template_url'); ?>/images/pic3.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                   <!-- <div class="gallery-details">
            ...
            <!-- /.gallery-item-wrapper -->
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper photobooth nature">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                          <img src="<?php bloginfo('template_url'); ?>/images/pic4.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                   <!-- <div class="gallery-details">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <img src="<?php bloginfo('template_url'); ?>/images/pic5.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                    <!--<div class="gallery-details">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper events photobooth">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <img src="<?php bloginfo('template_url'); ?>/images/pic6.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                    <!--<div class="gallery-details">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper nature outside">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <img src="<?php bloginfo('template_url'); ?>/images/pic7.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                <!--    <div class="gallery-details">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper photography events">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                            <img src="<?php bloginfo('template_url'); ?>/images/pic8.jpg" border="0" alt="" title="" class="img-responsive"/>
                        <div class="image-overlay"></div>
                        <a href="http://placehold.it/800x600" class="gallery-zoom"><i class="fa fa-eye"></i></a>
                    </div>
                 <!--   <div class="gallery-details">
