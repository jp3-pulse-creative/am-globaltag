...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>10/library/js/plugins.js"></script> 
<!--<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/library/js/bskit-scripts.js"></script>-->
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>10/library/js/jquery.slicknav.js"></script>
