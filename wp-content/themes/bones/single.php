...
<section class="content-block tho-lead">
  ...
  <div class="soc-share">
	...
	<li><a href="https://www.facebook.com/sharer.php?u=<?php echo get_site_url(); ?>/10thanniversary/<?php echo $post->post_name; ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/soc-fb.png" /></a></li>
	<li><a href="https://twitter.com/home?status=http%3A//www.am-globaltag.com/10thanniversary/<?php echo $post->post_name; ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/soc-tw.png" /></a></li>
	<li><a href="https://plus.google.com/share?url=http%3A//www.am-globaltag.com/10thanniversary/<?php echo $post->post_name; ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/soc-go.png" /></a></li>
