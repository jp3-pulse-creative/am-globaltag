<!--
<div id="section-intel-alm">
	<center>
		<a href="https://www.alvarezandmarsal.com/insights/am-named-leader-within-transactions-acquisitions-consulting-industry-alm-intelligence" target="_blank"><div class="sialm-link"></div></a>
		<img class="sialm-img desktop-only" src="<?php bloginfo('template_directory'); ?>/images/intel-alm-back-content.svg" border="0" />
		<img class="sialm-img mobile-only" src="<?php bloginfo('template_directory'); ?>/images/intel-alm-back-content-m.svg" border="0" />
		</center>
	</div>
-->
...
<script>
	$(document).ready(function($) {
		...
		$('.slick-prev, .slick-next').click(function() {
			...
			$('#youtube4').attr('src', $('#youtube4').attr('src'));
			$('#youtube5').attr('src', $('#youtube5').attr('src'));
			$('#youtube6').attr('src', $('#youtube6').attr('src'));
