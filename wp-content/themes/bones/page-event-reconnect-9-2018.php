<?php
/*
 Template Name: Events Reconnect September 2018
 *
...
<section id="promo-rsvp" class="content-block promo-rsvp tho-top"> 
  ...
  <div class="col-md-10">
  <div class="tho-in">
	  <center>  <img class="single-header-image-22222" src="<?php bloginfo('template_url'); ?>/images/amb2b9-2018-1.png" />  </center>
   <h2></h2>
...
<section class="content-block-1 tho-lead">
 ...
 <p style="font-size: 18px; line-height: 22px;">Thank you all for coming to our Alvarez & Marsal Private Equity Services’ Back to Business networking event.
Here's a few moments from the evening. Enjoy!</p>
  ...
  <div class="container">
<iframe id="youtube1" src="https://www.youtube.com/embed/Oeo4Akk67SA?rel=0" frameborder="0" allowfullscreen></iframe>
	  </div>
  </div>
<!--/video========-->
  ...
  <div id="section-reconnect5">
	  <center>
		  <a href="https://pulsecreative.zenfolio.com/p1031944827" target="_blank"><img class="" src="<?php bloginfo('template_url'); ?>/images/amb2b9-2018-4.png"/></a>
