...
<?php the_field('css'); ?>
		...
		.tl-current a{border-bottom: 4px solid #00355F !important;}
            #menu-main-menu .trends-current {border-bottom: 4px solid #00355F !important;}            
...
<section class="content-block-1 tho-lead">
 ...
 <div class="col-md-1">
  <div class="soc-share">
	...
	<li><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_permalink(); ?>" target="_blank"><span class="fa fa-linkedin-square"></span></a></li>
