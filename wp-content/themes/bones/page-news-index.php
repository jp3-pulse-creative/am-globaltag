...
<!--  <div class="overlay"></div>-->
  ...
  <div class="carousel-inner">
    ...
    <div class="item slides active">
      ...
      <div class="slide-news-1" style="background-image:url(<?php echo get_site_url(); ?>/wp-content/uploads/2016/05/sellside-bg-1.jpg)"></div>
        <a href="https://www.unquote.com/nordics/news/3005296/alvarez-marsal-opens-stockholm-office-hires-three"> 
      <div class="hero-2">
       <h2>Alvarez &amp; Marsal Opens Stockholm Office, Hires Three</h2>
		  <p>June 12, 2017  |  Europe</p>
	</div>
	   </a>
...
<!---->
  ...
  <div class="item slides">
       <div class="slide-news-2" style="background-image:url(<?php echo get_site_url(); ?>/wp-content/uploads/2017/02/press-header-how-long-will.jpg)"></div>
        <a href="https://www.consultingmag.com/sites/cmag/2017/06/08/alvarez-marsal-opens-stockholm-office/?slreturn=20170603133245"> 
      <div class="hero-2">
       <h2>Alvarez &amp; Marsal Opens Stockholm Office</h2>
		  <p>June 8, 2017  |  Europe</p>
	</div>
	   </a>
...
<!---->
   ...
   <div class="item slides">
    <div class="slide-news-3" style="background-image:url(<?php echo get_site_url(); ?>/wp-content/uploads/2017/02/tl-bg2.jpg)"></div>
  <a href="https://www.abladvisor.com/news/12022/alvarez-marsal-expands-global-footprint-nabs-three-top-execs-from-kpmg">
      <div class="hero-2">
       <h2>Alvarez &amp; Marsal Expands Global Footprint, Nabs Three Top Execs From KPMG</h2>
		  <p>June 8, 2017 | Europe</p>
	</div>
	   </a>
...
<div id="section-4" class="row">
	<h2 class="inner">LATEST NEWS / PRESS:</h2>
		<p class="landing">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
<?php $loop = new WP_Query( array( 'post_type' => 'news', 'posts_per_page' => -9999 ) ); ?>
