<?php
/*
 Template Name: Thought Leadership (GLOBAL)
 *
...
<section class="content-block-1 tho-lead">
 ...
 <div class="col-md-1">
  <div class="soc-share">
	...
	<li><a href="https://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>&title=<?php echo the_title(); ?>" target="_blank"><span class="fab fa-facebook-square"> </span></a></li>
	 <li><a href="https://twitter.com/share?url=<?php the_permalink(); ?>&media=<?php echo the_field('header-image'); ?>&hashtag=" target="_blank"><span class="fab fa-twitter"> </span></a></li>
