<header class="header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
  <div id="inner-header" class="wrap cf">
    <nav role="navigation" class="navbar navbar-default2 navbar-fixed-top" itemscope itemtype="https://schema.org/SiteNavigationElement"> 
...
<!--			<a href="https://www.alvarezandmarsal.com/" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/am-tag-logo-small.svg" border="0" /></a>-->
			   ...
			   <div class="top-external-nav2">
<!--				   <a href="https://www.paulaversano.com/" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/am-tag-logo-small2.svg" border="0" /></a>-->
			  </div>
		  ...
		  <div class="mobile-menu-sec">
            <?php 
				wp_nav_menu(array(
				 'container' => false,                           // remove nav container
				 'container_class' => 'menu cf',                 // class of container (should you choose to use it)
				 'menu' => __( 'Mobile', 'bonestheme' ),  // nav name
