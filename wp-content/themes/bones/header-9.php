...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/css/blocks-bing.css" />
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/css/custom.css" />
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/library/css/lity.css" />
	...
	<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/library/js/lity.js"></script>
	...
	<?php if (is_single()) { ?>
		...
		<meta property="og:description" content="<?php echo strip_tags(the_field('home-excerpt')); ?>" />
		...
		<meta name="twitter:description" value="<?php echo strip_tags(the_field('home-excerpt')); ?>" />
