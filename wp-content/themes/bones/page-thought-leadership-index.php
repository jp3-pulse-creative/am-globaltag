<?php
/*
 Template Name: Thought Leadership Index
 *
  ...
  <div class="carousel-inner">
    ...
    <div class="item slides active">
      ...
      <div class="hero-2">
       ...
       <h2>China: <br/>The Liberalization of the Reminbi, and Investing in <br/>High Risk Offshore Sectors</h2>
		  <p>January 31st, 2017  |  New York, NY</p>
	</div>
	   </a>
...
<!---->
  ...
  <div class="item slides">
      ...
      <div class="hero-2">
		 <h3>Thought Leadership:</h3>
       <h2>Disruption and Evolution:<br/> Financial Services M&A <br/>Trends to Watch</h2>
		  <p>May 9th, 2016  |  New York, NY</p>
	</div>
	   </a>
...
<!---->
  ...
  <a href="<?php echo get_site_url(); ?>/thought_leadership/ten-years-of-healthcare-industry-investing-dynamic-change-new-opportunities/">
      <div class="hero-2">
		  <h3>Thought Leadership:</h3>
    <h2>Ten Years of <br/>Healthcare Industry Investing: <br/>Dynamic Change, New Opportunities</h2>
		  <p>May 6th, 2015  |  New York, NY</p>
	</div>
	   </a>
...
<?php $loop = new WP_Query( array( 'post_type' => 'thought_leadership', 'posts_per_page' => -9999 ) ); ?>
